      ...
      <main>
        ...
        <section className="relative min-h-[550px] flex items-center">
          <div className="absolute inset-0">
            <img 
              src="https://imhttps://https://rollercoastercafe.com/assets/images/hero-img-litti%20(1).png.com/assets/images/hero-img-litti%20(1).pngages.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=1600&q=80"
              alt="Roller Coaster Cafe"
        ...
        <section className="py-20 bg-[#faf8f5]">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="rounded-2xl overflow-hidden shadow-xl h-[200px] md:h-[300px] w-full">
                <img
